...
function Complaints() {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-10 items-center justify-center bg-primary md:p-0 px-10 max-h-screen overflow-y-auto pt-80 md:pt-80 lg:p-0">
      <h1 className="text-white font-bold text-5xl mt-10">Complaints</h1>
      <div className="flex gap-5 flex-wrap items-center justify-center">
        <form
          method="POST"
          onSubmit={registerComplaint}
          className="md:w-96 w-full py-5 pb-7 px-10 bg-secondary rounded-lg shadow-custom-black flex flex-col gap-5"
        >
          <div>
            <label
              htmlFor="description"
        ...
        <div className="w-full md:w-80 max-w-md max-h-96 p-4 border rounded-lg shadow-custom-black sm:p-8 bg-secondary border-neutral-900 drop-shadow-xl overflow-y-auto">
