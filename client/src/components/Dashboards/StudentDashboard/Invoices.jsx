...
function Invoices() {
  ...
  useEffect(() => {
    ...
    fetch("https://hostel-management-ofhb.vercel.app/api/invoice/student", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="w-full h-screen flex flex-col gap-5 items-center justify-center max-h-screen overflow-y-auto">
      ...
      <div className="w-full max-w-md p-4 border rounded-lg shadow-custom-black sm:p-8 bg-secondary border-neutral-900 drop-shadow-xl overflow-y-auto max-h-70">
