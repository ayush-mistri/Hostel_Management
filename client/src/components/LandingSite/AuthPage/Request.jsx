...
export default function RequestAcc() {
  const register = (event) => {
    ...
    fetch("https://hostel-management-ofhb.vercel.app/api/request/register", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="w-full rounded-lg md:mt-0 sm:max-w-md xl:p-0 bg-secondary border-gray-700 shadow-custom-black">
